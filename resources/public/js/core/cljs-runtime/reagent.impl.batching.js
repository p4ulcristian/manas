...
return (function (){var or__5142__auto__ = w.requestAnimationFrame;
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
var or__5142__auto____$1 = w.webkitRequestAnimationFrame;
if(cljs.core.truth_(or__5142__auto____$1)){
return or__5142__auto____$1;
} else {
var or__5142__auto____$2 = w.mozRequestAnimationFrame;
if(cljs.core.truth_(or__5142__auto____$2)){
return or__5142__auto____$2;
} else {
var or__5142__auto____$3 = w.msRequestAnimationFrame;
...
var n__5741__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__5741__auto__)){
var fexpr__22047_22085 = (fs[i]);
(fexpr__22047_22085.cljs$core$IFn$_invoke$arity$0 ? fexpr__22047_22085.cljs$core$IFn$_invoke$arity$0() : fexpr__22047_22085.call(null));
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Enqueued function"+" must not be nil"))+"\n"+"f")));
}
...
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__22050) : reagent.impl.batching.next_tick.call(null,G__22050));
}
}));
...
(reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.batching/RenderQueue");
}));
