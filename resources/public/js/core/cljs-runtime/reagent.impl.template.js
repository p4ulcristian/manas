...
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/UnsafeHTML");
}));
...
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__24572 = o;
reagent.impl.template.goog$module$goog$object.set(G__24572,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__24829__i < G__24829__a.length) {G__24829__a[G__24829__i] = arguments[G__24829__i + 0]; ++G__24829__i;}
  args = new cljs.core.IndexedSeq(G__24829__a,0,null);
} 
...
var G__24586 = o;
reagent.impl.template.goog$module$goog$object.set(G__24586,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__24833__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__24834__i < G__24834__a.length) {G__24834__a[G__24834__i] = arguments[G__24834__i + 0]; ++G__24834__i;}
  args = new cljs.core.IndexedSeq(G__24834__a,0,null);
} 
return G__24833__delegate.call(this,args);};
G__24833.cljs$lang$maxFixedArity = 0;
G__24833.cljs$lang$applyTo = (function (arglist__24835){
var args = cljs.core.seq(arglist__24835);
return G__24833__delegate(args);
});
...
var G__24598 = props;
var G__24598__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24598,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24598);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24598__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24605 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24605,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24605;
}
})(),id_class);
...
var temp__5823__auto___24838 = (function (){var and__5140__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___24838)){
var d_24839 = temp__5823__auto___24838;
if((d_24839 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24839.s}));
} else {
...
var G__24606 = (cljs.core.count(argv) - first_child);
switch (G__24606) {
case (0):
...
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__24613 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24613,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24613,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24613,(2),null);
var className__$1 = (((className == null))?null:clojure.string.replace(className,/\./," "));
if(cljs.core.truth_(tag)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Invalid tag: '"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccup_tag)+"'"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.component.comp_name())))+"\n"+"tag")));
}
...
var temp__5827__auto___24854 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___24854 == null)){
} else {
var key_24855 = temp__5827__auto___24854;
(jsprops.key = key_24855);
}
...
var temp__5827__auto___24856 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___24856 == null)){
} else {
var key_24857 = temp__5827__auto___24856;
(jsprops.key = key_24857);
}
...
var temp__5827__auto___24860 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___24860 == null)){
} else {
var key_24861 = temp__5827__auto___24860;
(jsprops.key = key_24861);
}
...
var jsprops = (function (){var or__5142__auto__ = reagent.impl.template.convert_prop_value(((hasprops)?props:null));
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return ({});
...
var temp__5827__auto___24870 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___24870 == null)){
} else {
var key_24871 = temp__5827__auto___24870;
(jsprops.key = key_24871);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__5142__auto__ = reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__5142__auto__)){
return or__5142__auto__;
} else {
return ({});
...
var temp__5827__auto___24897 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___24897 == null)){
} else {
var key_24898 = temp__5827__auto___24897;
(jsprops.key = key_24898);
}
...
var temp__5827__auto___24900 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___24900 == null)){
} else {
var key_24901 = temp__5827__auto___24900;
(jsprops.key = key_24901);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24690_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24690_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24698 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24698,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24698,(1),null);
if(cljs.core.truth_(derefed)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn((""+"Warning: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(x,reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Reactive deref not supported in lazy seq, ","it should be wrapped in doall"], 0)))));
} else {
}
} else {
}
...
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn((""+"Warning: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(x,reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Every element in a seq should have a unique :key"], 0)))));
} else {
}
} else {
}
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Invalid Hiccup tag"], 0)))+"\n"+"(= \">\" n)")));
}

break;
default:
var G__24908 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__24909 = compiler;
v = G__24908;
compiler = G__24909;
continue;
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Hiccup form should not be empty"], 0)))+"\n"+"(pos? (count v))")));
}

var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(0),null);
if(reagent.impl.template.valid_tag_QMARK_(tag)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,reagent.impl.component.comp_name(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Invalid Hiccup form"], 0)))+"\n"+"(valid-tag? tag)")));
}
...
*/
reagent.impl.template.t_reagent$impl$template24787 = (function (opts,id,fn_to_element,parse_fn,meta24788){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24787.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24789,meta24788__$1){
var self__ = this;
var _24789__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24787(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24788__$1));
}));

(reagent.impl.template.t_reagent$impl$template24787.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24789){
var self__ = this;
var _24789__$1 = this;
return self__.meta24788;
}));

(reagent.impl.template.t_reagent$impl$template24787.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24787.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24787.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24787.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24787.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24787.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24788","meta24788",-595082892,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24787.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24787.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24787");

(reagent.impl.template.t_reagent$impl$template24787.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template24787");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24787.
 */
reagent.impl.template.__GT_t_reagent$impl$template24787 = (function reagent$impl$template$__GT_t_reagent$impl$template24787(opts,id,fn_to_element,parse_fn,meta24788){
return (new reagent.impl.template.t_reagent$impl$template24787(opts,id,fn_to_element,parse_fn,meta24788));
});
...
return (new reagent.impl.template.t_reagent$impl$template24787(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
