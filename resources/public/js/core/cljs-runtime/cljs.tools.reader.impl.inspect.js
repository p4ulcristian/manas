...
var l = (cljs.core.truth_(truncate)?(0):cljs.core.min.cljs$core$IFn$_invoke$arity$2((10),n));
...
var suffix = (((l < n))?"...":null);
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(start)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(content)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(suffix)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(end));
});
...
cljs.tools.reader.impl.inspect.inspect_STAR_ = (function (){var method_table__5747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var hierarchy__5751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__24827 = cljs.core.get_global_hierarchy;
return (fexpr__24827.cljs$core$IFn$_invoke$arity$0 ? fexpr__24827.cljs$core$IFn$_invoke$arity$0() : fexpr__24827.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.tools.reader.impl.inspect","inspect*"),cljs.tools.reader.impl.inspect.dispatch_inspect,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__5751__auto__,method_table__5747__auto__,prefer_table__5748__auto__,method_cache__5749__auto__,cached_hierarchy__5750__auto__));
})();
}
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1("\"")+cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.substring((0),cljs.core.min.cljs$core$IFn$_invoke$arity$2(n,x.length)))+cljs.core.str.cljs$core$IFn$_invoke$arity$1(suffix));
}));
