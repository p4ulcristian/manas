...
var i_22779 = (0);
while(true){
if((i_22779 < arr.length)){
(arr[i_22779] = null);

var G__22782 = (i_22779 + (1));
i_22779 = G__22782;
continue;
} else {
}
...
var i_22807 = (self__.level + (1));
while(true){
if((i_22807 <= (new_level + (1)))){
(update[i_22807] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_22811 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_22811[i]));
} else {
x__$2.forward.push((((i < links_22811.length))?(links_22811[i]):null));
}

if((i < links_22811.length)){
(links_22811[i] = x__$2);
} else {
links_22811.push(x__$2);
}
...
var i_22819 = (0);
while(true){
if((i_22819 <= self__.level)){
var links_22820 = (update[i_22819]).forward;
if((x__$1 === (((i_22819 < links_22820.length))?(links_22820[i_22819]):null))){
(links_22820[i_22819] = (x__$1.forward[i_22819]));

var G__22824 = (i_22819 + (1));
i_22819 = G__22824;
continue;
} else {
var G__22825 = (i_22819 + (1));
i_22819 = G__22825;
continue;
}
} else {
...
var G__22827 = nx;
var G__22828 = (level__$1 - (1));
x = G__22827;
level__$1 = G__22828;
continue;
} else {
var G__22829 = x;
var G__22830 = (level__$1 - (1));
x = G__22829;
level__$1 = G__22830;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__22834 = nx;
var G__22835 = (level__$1 - (1));
x = G__22834;
level__$1 = G__22835;
continue;
} else {
var G__22837 = x;
var G__22838 = (level__$1 - (1));
x = G__22837;
level__$1 = G__22838;
continue;
}
