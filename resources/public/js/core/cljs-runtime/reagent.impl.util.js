...
var vec__21889 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__21891;
var parts = seq__21890__$1;
...
var vec__21903 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str__$1,/-/);
...
var start = first__21905;
var parts = seq__21904__$1;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.str,start,cljs.core.map.cljs$core$IFn$_invoke$arity$2(reagent.impl.util.capitalize,parts));
}
});
reagent.impl.util.fun_name = (function reagent$impl$util$fun_name(f){
var n = (function (){var or__5142__auto__ = (function (){var and__5140__auto__ = cljs.core.fn_QMARK_(f);
if(and__5140__auto__){
var or__5142__auto__ = f.displayName;
...
var or__5142__auto____$1 = (function (){var and__5140__auto__ = (((!((f == null))))?(((((f.cljs$lang$protocol_mask$partition1$ & (4096))) || ((cljs.core.PROTOCOL_SENTINEL === f.cljs$core$INamed$))))?true:false):false);
if(and__5140__auto__){
...
(reagent.impl.util.PartialFn.prototype.call = (function (unused__11864__auto__){
var self__ = this;
var self__ = this;
var G__21923 = (arguments.length - (1));
switch (G__21923) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args21922){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args21922)));
}));
...
(reagent.impl.util.PartialFn.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.util/PartialFn");
}));
...
var len__5876__auto___22061 = arguments.length;
var i__5877__auto___22062 = (0);
while(true){
if((i__5877__auto___22062 < len__5876__auto___22061)){
args_arr__5901__auto__.push((arguments[i__5877__auto___22062]));

var G__22063 = (i__5877__auto___22062 + (1));
i__5877__auto___22062 = G__22063;
continue;
} else {
}
break;
...
return reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5902__auto__);
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(a))+" "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(b)));
} else {
...
/** @this {Function} */
(reagent.impl.util.class_names.cljs$lang$applyTo = (function (seq21969){
...
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21970,G__21971,seq21969__$2);
}));
...
default:
var args_arr__5901__auto__ = [];
var len__5876__auto___22069 = arguments.length;
var i__5877__auto___22070 = (0);
while(true){
if((i__5877__auto___22070 < len__5876__auto___22069)){
args_arr__5901__auto__.push((arguments[i__5877__auto___22070]));

var G__22071 = (i__5877__auto___22070 + (1));
i__5877__auto___22070 = G__22071;
continue;
} else {
}
break;
...
var argseq__5902__auto__ = ((((2) < args_arr__5901__auto__.length))?(new cljs.core.IndexedSeq(args_arr__5901__auto__.slice((2)),(0),null)):null);
return reagent.impl.util.merge_props.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5902__auto__);
...
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Property must be a map, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1], 0)))))+"\n"+"(map? p1)")));
}
...
/** @this {Function} */
(reagent.impl.util.merge_props.cljs$lang$applyTo = (function (seq22009){
...
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22010,G__22011,seq22009__$2);
}));

(reagent.impl.util.merge_props.cljs$lang$maxFixedArity = (2));

reagent.impl.util._STAR_always_update_STAR_ = false;
reagent.impl.util.force_update = (function reagent$impl$util$force_update(comp){
...
if((i < len)){
var k = (ks[i]);
var G__22075 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),reagent.impl.util.goog$module$goog$object.get(o,k));
var G__22076 = (i + (1));
m = G__22075;
i = G__22076;
continue;
...
var G__22021 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(0),null);
var G__22021__$1 = (((G__22021 instanceof cljs.core.Keyword))?G__22021.fqn:null);
switch (G__22021__$1) {
case ">":
case "f>":
...
break;
case "r>":
var G__22022 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(2),null);
if((G__22022 == null)){
return null;
} else {
return G__22022.key;
...
var G__22027 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__22027)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__22027)){
return x;
} else {
...
var len__5876__auto___22081 = arguments.length;
var i__5877__auto___22084 = (0);
while(true){
if((i__5877__auto___22084 < len__5876__auto___22081)){
args__5882__auto__.push((arguments[i__5877__auto___22084]));

var G__22086 = (i__5877__auto___22084 + (1));
i__5877__auto___22084 = G__22086;
continue;
} else {
}
break;
...
return reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5883__auto__);
});

(reagent.impl.util.hiccup_err.cljs$core$IFn$_invoke$arity$variadic = (function (v,comp_name,msg){
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg))+": "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.util.str_coll(v))+"\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(comp_name));
}));

(reagent.impl.util.hiccup_err.cljs$lang$maxFixedArity = (2));

/** @this {Function} */
(reagent.impl.util.hiccup_err.cljs$lang$applyTo = (function (seq22029){
...
var self__5861__auto__ = this;
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22030,G__22031,seq22029__$2);
}));
