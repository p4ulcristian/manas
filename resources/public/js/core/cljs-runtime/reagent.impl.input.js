...
reagent.impl.input.get_true_active_element = (function reagent$impl$input$get_true_active_element(){
var active_element = document.activeElement;
while(true){
var temp__5821__auto__ = active_element.shadowRoot;
if(cljs.core.truth_(temp__5821__auto__)){
var shadow_root = temp__5821__auto__;
var G__22717 = shadow_root.activeElement;
active_element = G__22717;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__22641){
var map__22642 = p__22641;
var map__22642__$1 = cljs.core.__destructure_map(map__22642);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22642__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5142__auto__ = (!((((node === reagent.impl.input.get_true_active_element())) && (((reagent.impl.input.has_selection_api_QMARK_(node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5142__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__22652 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__22653 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__22653);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__22652);
}}));
} else {
...
if(cljs.core.truth_((function (){var and__5140__auto__ = (!((jsprops == null)));
if(and__5140__auto__){
var and__5140__auto____$1 = jsprops.hasOwnProperty("onChange");
...
(jsprops.onChange = (function (p1__22666_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__22666_SHARP_);
}));
